...
public class Event implements Comparable<Event> {
    ...
    private boolean inQueue; //checks if the event entered a queue at any point in time.
    ...
    //Checks if player is busy while entering training queue.
    ...
    //Checks if player is busy while entering massage queue.
