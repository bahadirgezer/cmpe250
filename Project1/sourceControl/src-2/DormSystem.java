...
public class DormSystem { //M.V.C. (Most Valuable Class) of the program.
    ...
    public void addStudent(int id, String name, int semester, double rating) { //creates Student object
        ...
        unmatchedStudents.put(id, student); //adds it to the initial collection for students
    }
    ...
    public void allocate() { //allocates every empty house a compatible student
        ...
        while(emptyIterator.hasNext()){ //first loop over empty houses
            ...
            while(unmatchedIterator.hasNext()) { //second loop over unmatched students
                ...
                if (house.getRating() >= student.getRating()) { //if they are compatible 
                    ...
                    emptyIterator.remove(); //house gets removed from emptyHouses
                    ...
                    unmatchedIterator.remove();  //mathced student is discarded
                    break; 
                }
            }
        }
